...
const styles = makeStyles(theme => ({
    ...
    mainDialog: {
        // backgroundColor: "red"
        background: "linear-gradient(69deg, rgba(238,174,202,1) 0%, rgba(183,186,190,1) 100%)"
                    ...
                    <form onSubmit={formSubmit}>
                        ...
                        }
                        {
                            logInInfo ?
                                ...
                                >Log IN</Button> : <Typography
                                    style={{ paddingLeft: "20px", paddingRight: "20px", fontSize: "19px", marginTop: "18px" }}
                        ...
                        }
                        {
                            logInInfo ? <Typography
                                style={{ paddingLeft: "20px", paddingRight: "20px", marginLeft: "20px", fontSize: "19px", marginTop: "18px" }}
                                className="btn btn-outline-secondary"
